...
import org.uniba.fmph.knet.generator.CollaborationUI;
...
public class CollaborationUIImpl extends AbstractGeneratorUI<Collaboration> implements CollaborationUI{
...
//		return validationPanel;
   ...
   protected JPanel createPanel() {
     ...
     initialdensityField = addSlider(content, "Part of module",0,100,20,10);               
     return content;
   }
